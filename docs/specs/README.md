...
**44 done · 4 in progress · 9 not started · 57 total.**
...
- [x] [open-mode-enforcement.md](open-mode-enforcement.md) — `PdfDocumentOpenMode` enforced where it is named: one `EnsureCanModify`, nineteen guarded operations, `InformationOnly` gone (#166, #168)
