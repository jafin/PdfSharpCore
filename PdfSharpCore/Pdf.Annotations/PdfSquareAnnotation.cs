...
public sealed class PdfSquareAnnotation : PdfAnnotation
{
    ...
    void Initialize()
    {
        Elements.SetName(Keys.Subtype, "/Square");
    ...
    void RebuildAppearance()
    {
        ...
        {
            if (pen == null)
                gfx.DrawRectangle(brush, drawn);
            else if (brush == null)
                gfx.DrawRectangle(pen, drawn);
            else
                gfx.DrawRectangle(pen, brush, drawn);
        }
    ...
    internal new class Keys : PdfAnnotation.Keys
    {
        ...
        /// boundaries of the underlying square.
        /// </summary>
